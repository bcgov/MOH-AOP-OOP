...
```bash
<Button label="Submit" styling="bcgov-normal-blue btn" />
```
...
```bash
<Button label="Submit" styling="bcgov-normal-white btn" />
```
...
```bash
<Button label="Disabled" styling="bcgov-normal-blue btn" v-bind:disabled="true" />
```
