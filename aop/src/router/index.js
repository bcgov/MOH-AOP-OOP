...
import AssignmentOfPaymentHealthAuth from "../views/AssignmentOfPaymentHealthAuth.vue";
import { routes, HealthAuthRoutes } from "./routes";
...
const router = new VueRouter({
  ...
  routes: [
    ...
    {
      path: "/ha",
      component: AssignmentOfPaymentHealthAuth,
      redirect: HealthAuthRoutes.SUBMISSION_INFO.path,
      children: [
        {
          path: HealthAuthRoutes.SUBMISSION_INFO.path,
          name: HealthAuthRoutes.SUBMISSION_INFO.name,
          component: HealthAuthRoutes.SUBMISSION_INFO.component,
          meta: {
            title: "Select a Form | Upload Tool",
            metaTags: [
              {
        ...
        {
          path: HealthAuthRoutes.REVIEW.path,
          name: HealthAuthRoutes.REVIEW.name,
          component: HealthAuthRoutes.REVIEW.component,
          meta: {
            title: "Review | Upload Tool",
            metaTags: [
              {
        ...
        {
          path: HealthAuthRoutes.CONFIRMATION.path,
          name: HealthAuthRoutes.CONFIRMATION.name,
          component: HealthAuthRoutes.CONFIRMATION.component,
          meta: {
            title: "Confirmation | Upload Tool",
            metaTags: [
              {
        ...
        {
          path: HealthAuthRoutes.SUBMISSION_ERROR.path,
          name: HealthAuthRoutes.SUBMISSION_ERROR.name,
          component: HealthAuthRoutes.SUBMISSION_ERROR.component,
          meta: {
            title: "Error | Upload Tool",
            metaTags: [
              {
    ...
    {
      path: HealthAuthRoutes.SENDING.path,
      name: HealthAuthRoutes.SENDING.name,
      component: HealthAuthRoutes.SENDING.component,
      meta: {
        title: "Sending | Upload Tool",
        metaTags: [
          {
    ...
    {
      path: HealthAuthRoutes.SESSION_END.path,
      name: HealthAuthRoutes.SESSION_END.name,
      component: HealthAuthRoutes.SESSION_END.component,
      meta: {
        title: "Session End | Upload Tool",
        metaTags: [
          {
