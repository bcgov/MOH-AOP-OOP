...
(function(CommonImageError) {
  ...
  CommonImageError[(CommonImageError["PDFnotSupported"] = 6)] =
    "PDFnotSupported";
        ...
        for (let fileIndex = 0; fileIndex < fileList.length; fileIndex++) {
          ...
          if (file.type === "application/pdf") {
            ...
            this.readPDF(
              ...
              error => {
                const imageReadError = new CommonImageProcessingError(
            ...
            blob => {
              ...
              reader.onload = function(evt) {
                ...
                if (imageModel.size > maxSizeBytes) {
                  const imageTooBigError = new CommonImageProcessingError(
        ...
        return errors.pipe(
          scan(
            ...
            (acc, error) => {
              ...
              if (
                acc < maxRetry &&
                error.errorCode === CommonImageError.TooBig
              ) {
                return acc + 1;
              } else {
                /**
