          ...
          <div class="modal-body">
            <p>
              <strong
                ...
                shared device like a computer at a library, school or
                café.</strong
              >
              To delete any information that was entered, either complete the
              request and submit it or, if you don't finish, close the web
              browser.
            </p>
            <p>
              ...
              purposes of administration of the Medical Services Plan. If you
              have any questions about the collection and use of your personal
              information, please contact
              <a href=""
                >Health Insurance BC<i
                  aria-hidden="true"
