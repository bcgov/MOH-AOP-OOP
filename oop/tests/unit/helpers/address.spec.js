import { truncateAddressLines as testFunction } from "@/helpers/address.js";
...
describe("Helper address.js", () => {
  ...
  it.skip("does not turn trailing spaces into individual elements", () => {
    const result = testFunction(["AAAAA ", "BBBBB ", "CCCCC "], 2);
  ...
  it("works on data formatted like addresses (case 2)", () => {
    const result = testFunction(["716 Yates Street Victoria, BC V8W 1K4"], 12);
