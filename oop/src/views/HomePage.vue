  ...
  <div>
    ...
    <PageContent>
      <div class="container pt-3 pt-sm-5 mb-5">
        ...
        <p>
          If you are permanently moving out of British Columbia (B.C.), you must notify Health
          Insurance BC (HIBC) of your departure date and your new address.
        </p>
        <ul>
          <li>
            <b>If you are moving within Canada:</b> coverage is provided for the remainder of the
            month in which you leave the province plus the next two months. If required, your
            coverage may be extended for up to three extra months to cover you while in transit.
            Upon arrival, you should immediately apply to the health plan of the new province or
            territory.
          </li>
          <li>
        ...
        <div class="row">
          <div class="col-md-6">
            <h2>Requirements</h2>
            <p>
              Your Personal Health Number (PHN) is the 10 digit number that can be found on the back
              of your
              <a
              ...
              (or front of your CareCard if you still have one).
            </p>
          </div>
          <div class="col-md-6">
            <img
        ...
        <p>
          HIBC will process your request. We will contact you by mail (if address is provided) if
          there are any issues cancelling your MSP coverage. A confirmation letter will be sent to
...
export default {
  ...
  async created() {
    ...
    await spaEnvService
      ...
      .then(() => {
        if (spaEnvService.values && spaEnvService.values.SPA_ENV_OOP_MAINTENANCE_FLAG === "true") {
          this.$store.commit(
            formModule + "/" + SET_MAINTENANCE_MESSAGE,
            spaEnvService.values.SPA_ENV_OOP_MAINTENANCE_MESSAGE
          );
    ...
    logService.logNavigation(applicationUuid, routes.HOME_PAGE.path, routes.HOME_PAGE.title);
  },
  methods: {
